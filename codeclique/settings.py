"""
Django settings for codeclique project.
...
WSGI_APPLICATION = 'codeclique.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CodeClique API',
    'DESCRIPTION': "L'API de CodeClique.",
    'VERSION': '1.0.0',
